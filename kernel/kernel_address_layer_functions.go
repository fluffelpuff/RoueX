...
func (obj *Kernel) EnterL2Package(pckge *EncryptedAddressLayerPackage, conn RelayConnection) error {
...
func (obj *Kernel) WriteL2PackageByNetworkRoute(pckge *EncryptedAddressLayerPackage) (*extra.PackageSendState, bool, error) {
...
func (obj *Kernel) DecryptLocallyPackageToBuffer(pckge *EncryptedAddressLayerPackage) error {
...
func (obj *Kernel) EncryptPlainL2PackageAndWriteByNetworkRoute(pckge *PlainAddressLayerPackage) (*extra.PackageSendState, bool, error) {
	// Die Inneren Verschlüsselten Daten werden übertragen
	internal_data := EncryptedInnerData{
	...
	builded_encrypted_package := EncryptedAddressLayerPackage{
		Sender:           pckge.Sender,
...
func (obj *Kernel) EnterBytesAndSendL2PackageToNetwork(protocol_type uint8, package_bytes []byte, reciver_pkey *btcec.PublicKey) (*extra.PackageSendState, bool, error) {
	...
	builded_locally_package := PlainAddressLayerPackage{Reciver: *reciver_pkey, Sender: *obj.GetPublicKey(), IsLocallyCreated: true, Protocol: protocol_type, Body: package_bytes}
